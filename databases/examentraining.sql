...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `leerlingen` (`id_leerling`, `naam`, `klas`) VALUES (1,'Alice Pieters','H5A'),(2,'Bob Bouwma','H5A'),(3,'Cindy Young','H5B'),(4,'Dirk Nauta','H5A'),(5,'Eve Ning','H5B');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vakken` (
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `vakken` (`docentnaam`, `vak`, `docentcode`, `lokaal`) VALUES ('Schreuder','Engels','SCI','A104'),('Scheffers','Geschiedenis','SCL','B409'),('Palsma','Natuurkunde','PLP','B206'),('Hoekstra','Nederlands','HOJ','A202'),('Bakker','Wiskunde','BAH','A105');
